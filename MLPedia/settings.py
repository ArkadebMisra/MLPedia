"""
Django settings for MLPedia project.
...
SECRET_KEY = 'django-insecure-aw97-ojf2!pwff29^%7fu&-r4eh=#rltgdgfjew%iw50hmn==x'
...
WSGI_APPLICATION = 'MLPedia.wsgi.application'
