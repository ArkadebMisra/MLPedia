...
# data1, labels1 = xor()
# data1, labels1 = super_simple_separable()
data1, labels1 = gen_lin_separable()
pc = Perceptron()
pc.run_perceptron(data1, labels1)
th, th_0 = pc.th, pc.th0
ax = plot_data(data1, labels1)
plot_separator(ax, th, th_0)
plt.ioff()
plt.show()
print(pc.accuracy(data1, labels1))
print(pc.predict_label(np.array([[-4], [1]])))
